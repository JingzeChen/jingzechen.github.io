# Reading Input: Lecture 13 - Distributed Transactions
...
- Part 13: Lecture 13 - Distributed Transactions (https://www.bilibili.com/video/BV16f4y1z7kn/?p=13)

## Resources

### reading: 6.033 Chapter 9
...
- Local path: (external only)

#### Archive Boundary

The resource is external-only; use the official URL and do not invent its content.

### faq: FAQ

- URL: http://nil.csail.mit.edu/6.824/2021/papers/chapter9-faq.txt
- Local path: official-materials/faqs/chapter9-faq.txt
...
is useful in non-distributed setting and distributed setting.

2PC is a scheme to execute a transaction across multiple machine,
...
also implement deadlock detection by constructing a wait-for-graph as
...
- URL: http://nil.csail.mit.edu/6.824/2021/questions.html?q=q-chapter9&lec=13
- Local path: official-materials/questions/13-q-chapter9.html
