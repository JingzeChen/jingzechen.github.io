# Reading Input: Lecture 2 - RPC and Threads
...
- Part 2: Lecture 2 - RPC and Threads (https://www.bilibili.com/video/BV16f4y1z7kn/?p=2)

## Resources

### reading: Online Go tutorial
...
- URL: http://nil.csail.mit.edu/6.824/2021/papers/tour-faq.txt
- Local path: official-materials/faqs/tour-faq.txt
...
A: I haven't done a scientific study, but I imagine that these are on
the list:

- Not protecting map's with locks when there is concurrent access.  (But
use the race detector to catch those).

- Deadlocks with channels.

- Not capturing a variable when creating a go routine.
...
embedded structs, which allows you to do many things for which you
...
- URL: http://nil.csail.mit.edu/6.824/2021/questions.html?q=q-gointro&lec=2
- Local path: official-materials/questions/02-q-gointro.html
