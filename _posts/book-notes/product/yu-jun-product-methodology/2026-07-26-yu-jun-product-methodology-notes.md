...
> 企业以产品为媒介，与用户进行价值交换；产品经理通过理解用户模型和交易模型，设计并推动产品，促成更多可持续的交易，从而创造有利可图的用户价值。
...
4. 方法论怎样用于实际工作。
5. 结论成立需要哪些前提，有什么边界。
6. 哪些内容是原书观点，哪些是笔记中的进一步归纳。

## 章节目录与进度

| 章节 | 主题 | 状态 |
|---|---|---|
| 第一章 | [什么是产品经理]({% post_url book-notes/product/yu-jun-product-methodology/2026-07-26-yu-jun-product-methodology-ch01-product-manager %}) | 已完成 |
| 第二章 | [企业、用户、产品]({% post_url book-notes/product/yu-jun-product-methodology/2026-07-26-yu-jun-product-methodology-ch02-enterprise-user-product %}) | 已完成 |
