...
技术达到市场要求的交点满足 $S(t^{\ast})=R(t^{\ast})$：

$$
S_0(1+g_s)^{t^{\ast}}=R_0(1+g_r)^{t^{\ast}}
$$

两边除以 $S_0(1+g_r)^{t^{\ast}}$：

$$
\left(\frac{1+g_s}{1+g_r}\right)^{t^{\ast}}=\frac{R_0}{S_0}
$$

两边取自然对数：

$$
t^{\ast}\ln\left(\frac{1+g_s}{1+g_r}\right)=\ln\left(\frac{R_0}{S_0}\right)
$$
...
$$
t^{\ast}=\frac{\ln(100/60)}{\ln(1.3/1.1)}\approx3.06\text{ 年}
$$
