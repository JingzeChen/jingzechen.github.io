...
练习结束时的好成绩，既可能来自已经形成的持久能力，也可能来自材料仍在眼前、答案刚刚看过、题型连续不变等临时支持。后者能让人当场答得很顺，却未必能在几天后独立完成同样的任务。

因此，练习时成绩提高不足以单独证明真正学会。判断一种方法是否有效，要等一段时间后撤掉提示再次测试，还要适当改变题目或情境，看看学习者能否把知识用于新的问题。延迟后仍记得、没有答案也能想起、换了情境仍会用，才是更可靠的学习证据。
...
可以把“可用知识”理解成三个环节共同作用的结果：脑中确实存有相关知识、在压力和时间限制下能及时提取、并且能判断它是否适用于当前情境。只要其中一个环节明显薄弱，实际表现就会被拖住。比如，脑中没有知识当然无从调用；存过却想不起也无法使用；能想起却不会判断适用条件，同样可能失败。
...
所以不能把它理解成“越痛苦越有效”。更准确的说法是：与学习目标相关、难度适中、并且能获得成功或纠错反馈的认知努力，才更可能形成持久学习。

### 3. 为什么人不善于判断自己是否学会

学习结果是延迟的，学习感受却是即时的。人能直接体验眼前是否顺畅，却不能直接看到长期记忆是否稳固。于是就会出现一种常见偏差：主观预测很乐观，但延迟后的真实表现并没有同步提高。

连续重读会明显提升“看起来很熟”的感觉，学习者更容易高估一周后的表现；无提示自测则更接近未来真实任务，通常能把这种高估拉回到更准确的水平。
...
如果同一内容在很短时间内连续练，前一次答案或动作还停留在工作记忆里，这就属于典型的集中练习。考试前突击复习、连续做大量同型题都是常见形式。
...
集中安排常见的样子是：先把甲类题连续做完，再做乙类，再做丙类。

穿插安排则是把甲、乙、丙三类题交替混合，让你每做一道都先判断“这题到底属于哪一类、该用哪条规则”。
...
很多任务都同时包含“关键特征”和“表面特征”。如果练习材料的外观几乎完全一样，学习者很容易把表面线索误当成解题规则。多样化练习的价值在于：让表面线索不断变化，同时保留真正决定类别与原理的关键特征，逼着学习者抓住本质。
...
要证明“按风格匹配就更有效”，必须看到清晰的交叉结果：视觉偏好者在视觉教学下更好，听觉偏好者在听觉教学下更好。仅仅出现“视觉材料总体更好”或“某类学生总体更高分”，都不能证明匹配假说成立。
...
有效测验应尽量满足**任务一致性**：测验里要求的核心知识和操作越接近未来真实任务，测验结果就越能反映真实能力。

但这不等于练习题必须和真实任务长得一模一样。更好的做法是保留核心能力要求，同时适当改变表面情境，用来检查迁移。
...
细化不是把笔记写得更长，而是把新知识和已有知识建立可解释的联系。关系可以是“属于”“导致”“对比”“组成”“应用于”或“是……的例子”。
...
可以把心智模型理解成一种有结构的内部地图：里面有关键对象和状态，它们彼此如何关联，以及在什么条件下会发生什么变化、该采取什么操作。它的作用是帮助学习者抓住结构，并据此解释、预测和行动。
...
更稳妥的理解是：人的能力会随着练习质量、先备知识、反馈纠错以及资源环境共同变化。这个观点既强调可发展性，也承认现实条件差异；它不支持“只要相信就一定成功”。
...
正确结论是：重复暴露本身，不会自动把目标细节变成持久、可提取的记忆。
...
可以把它理解成“重读相对单读的优势会随时间变化”。连续重读在立刻测验时可能有一点点优势，但延迟拉长后，这个优势往往显著缩小甚至消失。因此不能用即时结果替代长期结论。
...
逻辑关系是：知识是高阶能力的重要基础，但通常不是充分条件。

只有知识而缺少分析与创造策略，可能只是会背；只有“会思考”的口号却缺少知识基础，也没有足够材料可分析和重组。现实中的任务表现还会受到环境、工具、时间和协作条件影响。
...
当研究在材料、样本、延迟和测试条件大体可比时，如果检索练习组在后续测试中的平均保持明显好于再次学习组，就说明出现了测验效应。
...
更实用的分配原则是：薄弱点越大，后续复习就应分配越多时间。

这不是要求机械计时，而是强调没有自测就无法识别薄弱点，学习者会本能地把时间继续花在最熟悉的内容上。
